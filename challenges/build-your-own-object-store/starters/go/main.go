// Starter template for "Build your own object store" (Go).
//
...
func handleRequest(req request) (result any, rpcErr *rpcError) {
	...
	// TODO (stage 3): head — metadata only, no body
	// TODO (stage 4): overwrite on put
	// TODO (stage 5): delete
	// TODO (stage 6): list by prefix, lexicographic order
	// TODO (stage 7): create_multipart / upload_part / complete_multipart
	// TODO (stage 8): persist objects and uploads to --data-dir
	// TODO (stage 9): gauntlet — everything durable across SIGKILL
...
func main() {
	...
	dataDir := flag.String("data-dir", "", "directory for durable state (used from stage 8)")
	flag.Parse()
	_ = dataDir
