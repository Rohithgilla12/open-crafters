...
func Challenge() harness.Challenge {
	...
	return harness.Challenge{
		...
		Stages: []harness.Stage{
			...
			{Slug: "append-read", Name: "Append and read by offset", Instructions: docs + "02-append-read.md", Test: testAppendRead},
			{Slug: "durability", Name: "Survive a crash", Instructions: docs + "03-durability.md", Test: testDurability},
			{Slug: "topics", Name: "Independent topics", Instructions: docs + "04-topics.md", Test: testTopics},
			{Slug: "consumer-groups", Name: "Consumer group offsets", Instructions: docs + "05-consumer-groups.md", Test: testConsumerGroups},
			{Slug: "replay", Name: "Replay and batching", Instructions: docs + "06-replay.md", Test: testReplay},
			{Slug: "retention", Name: "Retention keeps offsets absolute", Instructions: docs + "07-retention.md", Test: testRetention},
			{Slug: "offset-durability", Name: "Durable offsets and resume", Instructions: docs + "08-offset-durability.md", Test: testOffsetDurability},
