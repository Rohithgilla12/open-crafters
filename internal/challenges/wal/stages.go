...
func Challenge() harness.Challenge {
	...
	return harness.Challenge{
		...
		Stages: []harness.Stage{
			...
			{Slug: "kv", Name: "An in-memory key-value store", Difficulty: "easy", Instructions: docs + "02-kv.md", Test: testKV},
			{Slug: "persist", Name: "Survive a crash", Difficulty: "medium", Instructions: docs + "03-persist.md", Test: testPersist},
			{Slug: "format", Name: "Write the log format", Difficulty: "medium", Instructions: docs + "04-format.md", Test: testFormat},
			{Slug: "replay", Name: "Recover from any log", Difficulty: "medium", Instructions: docs + "05-replay.md", Test: testReplay},
			{Slug: "torn-writes", Name: "Torn writes", Difficulty: "hard", Instructions: docs + "06-torn-writes.md", Test: testTornWrites},
			{Slug: "checksums", Name: "Detect corruption", Difficulty: "hard", Instructions: docs + "07-checksums.md", Test: testChecksums},
			{Slug: "checkpoint", Name: "Snapshots and log truncation", Difficulty: "hard", Instructions: docs + "08-checkpoint.md", Test: testCheckpoint},
