// Starter notification platform gateway (TypeScript). Bind only.
    ...
    while ((idx = buf.indexOf("\n")) !== -1) {
      ...
      try {
        if (req.method === "ping") {
          ...
          void process.env.QUEUE_ADDR;
          void process.env.SCHEDULER_ADDR;
          void process.env.RATE_LIMITER_ADDR;
