// Starter for "Build your own distributed cache" (TypeScript, Bun). Passes stage 1 only.
    ...
    while ((idx = buf.indexOf("\n")) !== -1) {
      ...
      try {
        if (req.method === "ping") {
          ...
          throw new CacheError("UNKNOWN_METHOD", `unknown method ${JSON.stringify(req.method)}`);
        }
      } catch (e) {
