...
var ChallengePaths = []ChallengePath{
	...
	},
	{
		Slug:        "integration",
		Name:        "Compose & meta",
		Description: "Wire primitives into real systems — URL shortener, job platform, cache cluster, chat service, notification platform, and payment ledger gateways, plus building the grader itself. You build one service; the harness spawns the rest. (The workflow worker compose capstone lives on the workflow track; distributed KV on the distributed track.)",
		Challenges: []string{
