// Starter for distributed KV gateway (Go). Passes bind only.
package main
...
func handle(method string) (any, error) {
	...
	_ = os.Getenv("HASHRING_ADDR")
	_ = os.Getenv("RAFT1_ADDR")
	_ = os.Getenv("RAFT2_ADDR")
	_ = os.Getenv("RAFT3_ADDR")
	_ = os.Getenv("LSM_ADDR")
