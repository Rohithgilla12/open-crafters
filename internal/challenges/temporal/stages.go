...
func Challenge() harness.Challenge {
	...
	return harness.Challenge{
		...
		Stages: []harness.Stage{
			...
			{Slug: "start-workflow", Name: "Start a workflow", Difficulty: "easy", Instructions: docs + "02-start-workflow.md", Test: testStartWorkflow},
			{Slug: "complete-workflow", Name: "Dispatch and complete a workflow task", Difficulty: "medium", Instructions: docs + "03-complete-workflow.md", Test: testCompleteWorkflow},
			{Slug: "history", Name: "Append-only event history", Difficulty: "medium", Instructions: docs + "04-history.md", Test: testHistory},
			{Slug: "activities", Name: "Schedule and run activities", Difficulty: "medium", Instructions: docs + "05-activities.md", Test: testActivities},
			{Slug: "retries", Name: "Activity retries with backoff", Difficulty: "hard", Instructions: docs + "06-retries.md", Test: testRetries},
			{Slug: "timers", Name: "Durable timers", Difficulty: "medium", Instructions: docs + "07-timers.md", Test: testTimers},
			{Slug: "durability", Name: "Survive a crash", Difficulty: "hard", Instructions: docs + "08-durability.md", Test: testDurability},
			{Slug: "signals", Name: "Signals", Difficulty: "medium", Instructions: docs + "09-signals.md", Test: testSignals},
			{Slug: "concurrency", Name: "Concurrent workflows", Difficulty: "hard", Instructions: docs + "10-concurrency.md", Test: testConcurrency},
		},
	}
}
