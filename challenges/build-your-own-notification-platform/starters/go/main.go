// Starter for notification platform gateway (Go). Passes bind only.
package main
...
func handle(method string) (any, error) {
	...
	_ = os.Getenv("QUEUE_ADDR")
	_ = os.Getenv("SCHEDULER_ADDR")
	_ = os.Getenv("RATE_LIMITER_ADDR")
	// TODO: configure_limit, notify, schedule_notify, receive, ack
