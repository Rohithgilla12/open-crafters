"""Starter for workflow worker gateway (Python). Passes bind only."""
...
def handle(method, params):
    if method == "ping":
        return {"message": "pong"}
    _ = os.environ.get("TEMPORAL_ADDR")
    _ = os.environ.get("SDK_ADDR")
    # TODO: start_workflow, signal_workflow, await_workflow, run_workflow
