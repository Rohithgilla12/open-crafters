...
func Challenge() harness.Challenge {
	...
	return harness.Challenge{
		...
		Stages: []harness.Stage{
			...
			{Slug: "send-receive", Name: "Send, receive, ack", Instructions: docs + "02-send-receive.md", Test: testSendReceive},
			{Slug: "durability", Name: "Survive a crash", Instructions: docs + "03-durability.md", Test: testDurability},
			{Slug: "redelivery", Name: "Visibility timeouts", Instructions: docs + "04-redelivery.md", Test: testRedelivery},
			{Slug: "nack", Name: "Negative acknowledgement", Instructions: docs + "05-nack.md", Test: testNack},
			{Slug: "fencing", Name: "Receipt fencing", Instructions: docs + "06-fencing.md", Test: testFencing},
			{Slug: "dead-letter", Name: "Dead-letter queues", Instructions: docs + "07-dead-letter.md", Test: testDeadLetter},
			{Slug: "queues", Name: "Many queues and stats", Instructions: docs + "08-queues.md", Test: testQueues},
